...
if (NOT HAVE_CXX11)
  foreach(module_path ${CMAKE_MODULE_PATH})
    set(check_src_file "${module_path}/checks/cxx11.cpp")
    if (EXISTS "${check_src_file}")
      jstd_check_compiler_flag(CXX "" HAVE_CXX11 "${check_src_file}")
      if (NOT HAVE_CXX11 AND ENABLE_CXX11)
        jstd_check_compiler_flag(CXX "-std=c++11" HAVE_STD_CXX11 "${check_src_file}")
        if (HAVE_STD_CXX11)
